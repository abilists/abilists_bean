...
public class UserUbUcPostsModel extends BasicModel implements Serializable {
	...
	private List<UserCommentsPostsModel> subUserCommentsPostsList;

	UserUbUcPostsModel(){
	}

	public UserUbUcPostsModel(UserUbUcPostsModel userUbPosts){
		...
		this.setSubUserCommentsPostsList(userUbPosts.getSubUserCommentsPostsList());
	}
	...
	public List<UserCommentsPostsModel> getSubUserCommentsPostsList() {
		return subUserCommentsPostsList;
	}
	public void setSubUserCommentsPostsList(List<UserCommentsPostsModel> subUserCommentsPostsList) {
		this.subUserCommentsPostsList = subUserCommentsPostsList;
	}
